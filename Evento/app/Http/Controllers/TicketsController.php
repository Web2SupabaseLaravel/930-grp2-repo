...
class TicketsController extends Controller
{
    public function index()
    {
        ...
        $events = Event::all();
        return view('Ticket.index', compact('tickets', 'events'));
    }
...
public function create()
{
    ...
    return view('Ticket.create', compact('events', 'users'));
}
...
public function store(Request $request)
{
    ...
    public function edit(Ticket $ticket)
    {
        $events = Event::all();
        $users = User::all();
        return view('Ticket.edit', compact('ticket', 'events', 'users'));
    }
 ...
 public function destroy(Ticket $ticket)
{
    ...
    return redirect()->route('tickets.index')->with('success', 'تم الحذف بنجاح!');
}
